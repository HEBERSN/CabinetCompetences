...
$mod_strings = array (
  ...
  'LBL_BACKTOProspects' => 'Retour aux Prospects',
  ...
  'LBL_CONVERTprospect_BUTTON_KEY' => 'V',
  'LBL_CONVERTprospect_TITLE' => 'Convertir prospect [Alt+V]',
  'LBL_CONVERTprospect' => 'Convertir prospect',
  'LBL_CONVERTprospect_WARNING' => 'Attention : Le statut du prospect que vous souhaitez convertir est "converti". Un contact et/ou un compte ont sans doute déja été créés à partir des informations de ce prospect. Si vous souhaitez tout de même convertir ce prospect, cliquez sur "sauvegarder". Sinon cliquez sur "annuler" pour retourner sur la page précédente.',
  'LBL_CONVERTprospect_WARNING_INTO_RECORD' => ' Nous pensons que ce prospect a été converti vers ce contact : ',
  ...
  'LBL_LIST_prospect_SOURCE_DESCRIPTION' => 'Description origine principale',
  'LBL_LIST_prospect_SOURCE' => 'Origine principale',
  'LBL_LIST_MY_Prospects' => 'Mes Prospects',
  'LBL_LIST_PHONE' => 'Téléphone',
  'LBL_LIST_REFERED_BY' => 'Fait référence à',
  'LBL_LIST_STATUS' => 'Statut',
  'LBL_LIST_TITLE' => 'Fonction',
  'LBL_MODULE_NAME' => 'Prospects',
  'LBL_MODULE_TITLE' => 'Prospects',
  ...
  'LBL_SELECT_CHECKED_BUTTON_LABEL' => 'Utiliser Prospects sélectionnés',
  'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Utiliser Prospects sélectionnés',
  ...
  'LNK_NEW_prospect' => 'Créer une Prospect',
  ...
  'LBL_CAMPAIGN_prospect' => 'Campagne(s)',
  'LBL_BIRTHDATE' => 'Anniversaire :',
  'LBL_THANKS_FOR_SUBMITTING_prospect' => 'Merci. Votre inscription à bien été prise en compte.',
  ...
  'LBL_NOTICE_OLD_prospect_CONVERT_OVERRIDE' => 'Note: L&#39;écran de conversion de prospect suivant contient des champs personnalisés. Lorsque vous personnalisez l&#39;écran de conversion de prospect dans le studio pour la première fois, vous allez devoir ajouter vous même les champs personnalisés sur la vue. Les champs personnalisés n&#39;apparaitront plus automatiquement sur la vue comme cela était le cas auparavant.',
  ...
  'LBL_SELECTION_TIP' => 'Les modules liés avec le module contacts pourront être sélectionnés plutôt que créés durant le processus de conversion de prospect.',
  'LBL_EDIT_TIP' => 'Modification de la conversion de prospect pour ce module.',
  'LBL_DELETE_TIP' => 'Suppression de ce module lors de la conversion de prospect.',
  ...
  'LBL_CONVERTLEAD_TITLE' => 'Convertir prospect [Alt+V]',
  ...
  'LBL_LEAD_SOURCE_DESCRIPTION' => 'Description de la principale origine du prospect:',
  ...
  'LNK_NEW_LEAD' => 'Créer une Prospect',
  'LBL_LEAD_LIST' => 'Lise des Prospects',
