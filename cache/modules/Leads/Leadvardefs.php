 ...
 $GLOBALS["dictionary"]["Lead"]=array (
  ...
  array (
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'branche_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Leadsbranche_c',
      'custom_module' => 'Leads',
    ),
    'date_appel_prospect_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Date d\'appel',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'date_appel_prospect_c',
      'vname' => 'LBL_DATE_APPEL_PROSPECT',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Résultat prospect',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'resultat_prospect_c',
      'vname' => 'LBL_RESULTAT_PROSPECT',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'resultat_prospect_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Leadsresultat_prospect_c',
      'custom_module' => 'Leads',
    ),
    'saturation_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Saturation',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'saturation_c',
      'vname' => 'LBL_SATURATION',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'saturation_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Leadssaturation_c',
      'custom_module' => 'Leads',
    ),
    'statut_appel_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Statut d\'appel',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'statut_appel_c',
      'vname' => 'LBL_STATUT_APPEL',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'statut_appel_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Leadsstatut_appel_c',
      'custom_module' => 'Leads',
    ),
  ),
  'indices' => 
