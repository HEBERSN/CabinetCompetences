 ...
 $GLOBALS["dictionary"]["Case"]=array (
  ...
  array (
    ...
    array (
      ...
      'vname' => 'LBL_POLICE_SINISTRE_AOS_PRODUCTS_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      ...
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'assure_sinistre_c',
      'vname' => 'LBL_ASSURE_SINISTRE',
      'type' => 'int',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'code_sinistre_c',
      'vname' => 'LBL_CODE_SINISTRE',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    'date_enregis_sinistre_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Date enregistrement',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'date_enregis_sinistre_c',
      'vname' => 'LBL_DATE_ENREGIS_SINISTRE',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'size' => '20',
      'enable_range_search' => false,
      'id' => 'Casesdate_enregis_sinistre_c',
      'custom_module' => 'Cases',
    ),
    'date_survenance_sinistre_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Date survenance ',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'date_survenance_sinistre_c',
      'vname' => 'LBL_DATE_SURVENANCE_SINISTRE',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'size' => '20',
      'enable_range_search' => false,
      'id' => 'Casesdate_survenance_sinistre_c',
      'custom_module' => 'Cases',
    ),
    'jjwg_maps_address_c' => 
    array (
    ...
    array (
      ...
      'required' => false,
      'source' => 'non-db',
      'name' => 'police_sinistre_c',
      'vname' => 'LBL_POLICE_SINISTRE',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Casespolice_sinistre_c',
      'custom_module' => 'Cases',
    ),
    'responsabilite_sinistre_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Responsabilité (%)',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'responsabilite_sinistre_c',
      'vname' => 'LBL_RESPONSABILITE_SINISTRE',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => '8',
      'id' => 'Casesresponsabilite_sinistre_c',
      'custom_module' => 'Cases',
    ),
    'solde_sinistre_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Solde (XOF)',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'solde_sinistre_c',
      'vname' => 'LBL_SOLDE_SINISTRE',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Casessolde_sinistre_c',
      'custom_module' => 'Cases',
    ),
    'total_regle_sinistre_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Total réglé',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'total_regle_sinistre_c',
      'vname' => 'LBL_TOTAL_REGLE_SINISTRE',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Casestotal_regle_sinistre_c',
      'custom_module' => 'Cases',
    ),
    'type_sinitre_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Type de sinitre',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'type_sinitre_c',
      'vname' => 'LBL_TYPE_SINITRE',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'type_sinitre_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Casestype_sinitre_c',
      'custom_module' => 'Cases',
    ),
  ),
  'indices' => 
