<?php /* Smarty version 2.6.29, created on 2016-05-06 14:54:54
...
"><?php endif; ?></td></tr>
<tr><td class='mbLBL'><?php echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'COLUMN_TITLE_INLINE_EDIT_TEXT'), $this);?>
:</td><td><input type="hidden" name="inline_edit" value=""><input type="checkbox" name="inline_edit" value="1" <?php if (! empty ( $this->_tpl_vars['vardef']['inline_edit'] )): ?>CHECKED<?php endif; ?> <?php if ($this->_tpl_vars['hideLevel'] > 5): ?>disabled<?php endif; ?>/><?php if ($this->_tpl_vars['hideLevel'] > 5): ?><input type="hidden" name="inline_edit" value="<?php echo $this->_tpl_vars['vardef']['inline_edit']; ?>
"><?php endif; ?></td></tr>
