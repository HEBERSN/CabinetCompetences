...
//ABOUT page
    ...
    'LBL_VIEWLICENSE_COM' => '<P> Ce programme est un logiciel libre; vous pouvez le redistribuer et / ou le modifier selon les termes de la <a target="_blank" href="LICENSE.txt" class="body"> GNU Affero General Public License version 3 </a>  publiée par Free Software Foundation, y compris l\'autorisation supplémentaire indiqué dans l\'en-tête de code source. </ P>',
    'LBL_ADD_TERM_COM' => '<P> Les interfaces utilisateurs interactives dans des versions modifiées de codes source et objet de ce programme doivent afficher les Notices Légales Appropriées, comme l\'exige l\'article 5 de la version de licence GNU Affero General Public License 3. Conformément à l\'article 7 (b) de la GNU General License version 3 publique, ces notices légales Appropriées doiventt conserver l\'affichage de la & quot; Propulsé par SugarCRM & quot; logo. Si l\'affichage du logo ne est pas raisonnablement possible pour des raisons techniques, les Notices Légales Appropriées doit afficher les mots & quot; Propulsé par SugarCRM & quot;. </ P>',
  ...
  'LBL_JOIN_SUGAR_COMMUNITY' => 'Rejoigner la communauté SuiteCRM',
  'LBL_DETAILS_SUGARFORGE' => 'Participer et développer des extensions SuiteCRM',
 ...
 'LBL_GET_SUGARCRM_RSS' => 'Recevoir le flux RSS SuiteCRM',
  'LBL_SUGARCRM_NEWS' => 'SuiteCRM Actualités',
  'LBL_SUGARCRM_TRAINING_NEWS' => 'Actualités sur les formations SuiteCRM',
  'LBL_SUGARCRM_FORUMS' => 'Forums SuiteCRM',
  'LBL_SUGARFORGE_NEWS' => 'SuiteCRM Actualités',
  ...
  'LBL_DASHLET_DISCOVER_SUGAR_PRO' => 'Découvrir SuiteCRM',
    ...
    'LBL_LANGUAGE_SPANISH' => 'Traduction espagnole fournie par Disytel OpenConsulting',

    'LBL_ABOUT_SUITE_1' => 'SuiteCRM est un Fork de SugarCRM. De nombreux articles sur internet expliquent en quoi ce Fork était devenu nécessaire.',
    'LBL_ABOUT_SUITE_2' => 'SuiteCRM est publié sous une licence Open Source - GPL3',
    'LBL_ABOUT_SUITE_3' => 'SuiteCRM est totalement compatible avec SugarCRM 6.5.x',
