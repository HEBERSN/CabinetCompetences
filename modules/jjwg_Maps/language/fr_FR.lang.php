...
$mod_strings['LBL_HOMEPAGE_TITLE'] = 'Liste des cartes';
...
$mod_strings['LBL_MAP_ACTION'] = 'Afficher sur la carte';
$mod_strings['LBL_MAP_DISPLAY'] = 'Affichage de la carte';
$mod_strings['LBL_MAP_LEGEND'] = 'Légende :';
$mod_strings['LBL_MAP_USERS'] = 'Utilisateur:';
...
$mod_strings['LNK_IMPORT_MAPS'] = 'Importer des cartes';
$mod_strings['LBL_MAP_GEOCODE_ADDRESSES'] = 'Géocoder des adresses';
$mod_strings['LBL_MAP_DONATE'] = 'Donner';
$mod_strings['LBL_MAP_DONATE_TO_THIS_PROJECT'] = 'Donner pour ce projet';
$mod_strings['LBL_BUG_FIX'] = 'Résolutions de Bugs';
...
$mod_strings['LBL_MAP_GEOCODED_COUNTS'] = 'Nombre de géocodages';
...
$mod_strings['LBL_ADD_TO_TARGET_LIST_CONFIRM'] = 'Êtes-vous sûr de vouloir ajouter les éléments sélectionnés de la liste cible ?';
...
$mod_strings['LBL_CONFIG_ADDRESS_TYPE_SETTINGS_TITLE'] = "Paramètres de Type d'adresse : Ceci définit les types d'adresse de modules utilisés lors du géocodage des adresses. Les valeurs autorisées: « facturation » ; « d'expédition » ; « primaire » ; « alt » ; « flex_relate »";
...
$mod_strings['LBL_CONFIG_GEOCODING_API_URL_DESC'] = 'L\'URL du Proxy ou Google Maps API V3';
